    ...
    <div className="flex flex-col h-full text-white p-2 sm:p-4 gap-2">
      ...
      <div className="flex-grow w-full flex items-center justify-center relative min-h-0">
         <div className="card-glow bg-slate-800/50 rounded-2xl flex flex-col items-center justify-between p-2 sm:p-4 w-full h-full max-w-sm">
            ...
            {/* Clickable Coin Area */}
            <div
                className="relative cursor-pointer select-none no-context-menu w-full max-w-[224px] aspect-square border-2 border-slate-700/50 rounded-full my-auto shadow-inner bg-slate-900/50"
            ...
            >
                <div
                    className="absolute inset-0 rounded-full transition-transform duration-100 grid place-items-center"
