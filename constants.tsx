        ...
        <div className="card-glow bg-blue-900/30 border border-blue-500/50 rounded-2xl p-3 flex flex-col space-y-3">
             ...
             <div className="text-center p-2 bg-slate-900/50 rounded-lg">
                <p className="text-sm text-blue-200">
                    {isWalletAvailable ? t('use_main_button_to_connect') : t('wallet_feature_unavailable_launch')}
                </p>
            </div>
        </div>
    );
...
const MainApp: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const isWalletFeatureAvailable = !!tg.requestWalletAddress;
    ...
    if (shouldShowButton) {
        ...
        tg.MainButton.enable(); // Make sure it's re-enabled for next time
    }
