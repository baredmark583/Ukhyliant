...
export const TRANSLATIONS: Record<string, Record<TranslationKey, string>> = {
  en: {
    ...
    battle_boosts_desc: 'Use cell funds to get an edge in battle!',
  ...
  ua: {
    ...
    battle_boosts_desc: 'Використовуйте кошти осередку для переваги в битві!',
  ...
  ru: {
    ...
    battle_boosts_desc: 'Используйте средства ячейки для получения преимущества в битве!',
